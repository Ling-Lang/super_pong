...
function update_posi()
  ...
  hitboxp.x1, hitboxp.x2 = player.x, player.x+1
  hitboxp.y1, hitboxp.y2 = player.y-1, player.y + 1
//  hitboxe.x1, hitboxe.x2 = enemy.x, enemy.x+1
//  hitboxe.y1, hitboxe.y2 = enemy.y, enemy.y+8
end
